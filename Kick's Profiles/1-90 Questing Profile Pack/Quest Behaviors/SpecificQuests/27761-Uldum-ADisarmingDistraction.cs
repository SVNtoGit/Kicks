...
namespace Honorbuddy.Quest_Behaviors.SpecificQuests.ADisarmingDistraction
{
    ...
    public class BomberMan : CustomForcedBehavior // A Disarming Distraction
    {
            ...
            get
            {
                return
                    ObjectManager.GetObjectsOfType<WoWUnit>().Count(
                        u => u.IsHostile && (ClosestBomb!= null && u.Location.Distance(ClosestBomb.Location) <= 10));
            }
        ...
        public Composite FindBomb
        {
            get
            {
                return new Decorator(ret => ClosestBomb != null && Me.Location.Distance(ClosestBomb.Location) > 12,
                    new Action(delegate
                    {
        ...
        public Composite Mount
        {
            get
            {
                return new Decorator(ret => !Me.Mounted && ClosestBomb != null && ClosestBomb.Distance > 10,
