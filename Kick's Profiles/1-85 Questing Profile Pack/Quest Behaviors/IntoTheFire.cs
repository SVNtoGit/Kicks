...
namespace Styx.Bot.Quest_Behaviors
{
    public class IntoTheFire : CustomForcedBehavior
    {
        ...
        public WoWUnit Bad
        {
            get { return ObjectManager.GetObjectsOfType<WoWUnit>().Where(u => u.IsAlive && !u.IsPlayer && u.CurrentTarget != null && u.CurrentTarget != Good).OrderBy(u => u.Distance).FirstOrDefault(); }
        }
