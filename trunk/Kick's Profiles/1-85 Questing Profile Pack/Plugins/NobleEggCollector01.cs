...
namespace HighVoltz
{
	class NetherwingCollector: HBPlugin
	{
		...
		public static string name { get { return "EggCollector " + _version.ToString(); } }
		...
		public override string ButtonText { get { return "EggCollector"; } }
		...
		{
			Mount.MountUp();
			while (loc.Distance(Me.Location) > 150)
			{
		...
		static public void findAndPickupObject()
		{
			...
			List<WoWGameObject> objList = ObjectManager.GetObjectsOfType<WoWGameObject>()
				.Where(o => (o.Distance <= 150 &&
                    (CollectEggs && o.Entry == 113768) || 
                    (CollectEggs && o.Entry == 113769) || 
                    (CollectEggs && o.Entry == 113770) || 
                    (CollectEggs && o.Entry == 113771)
                    // (CollectEggs && o.Entry == 194047) || 
                    // (CollectEggs && o.Entry == 194054) || 
					))
				.OrderBy(o => o.Distance).ToList();
			foreach (WoWGameObject o in objList)
			{
				movetoLoc(WoWMovement.CalculatePointFrom(o.Location, -2));
				if (inCombat) 
				{
