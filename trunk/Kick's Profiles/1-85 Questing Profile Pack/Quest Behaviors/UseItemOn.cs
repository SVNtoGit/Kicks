...
namespace Styx.Bot.Quest_Behaviors
{
    ...
    public class UseItemOn : CustomForcedBehavior
    {
        ...
        public override string      SubversionId { get { return ("$Id: UseItemOn.cs 206 2011-09-27 22:07:57Z raphus $"); } }
        public override string      SubversionRevision { get { return ("$Revision: 206 $"); } }
