...
namespace Styx.Bot.Quest_Behaviors
{
    public class FireFromSky : CustomForcedBehavior
    {
        ...
        public List<WoWUnit> Enemies
        {
            ...
            {
                return
                    ObjectManager.GetObjectsOfType<WoWUnit>().Where(u => u.IsAlive && (u.Entry == 48720 || u.Entry == 48713)).OrderByDescending(z => UnfriendlyUnitsNearTarget(20, z)).ToList();
                ...
                return new Action(delegate
                                      {
                                          ...
                                          LegacySpellManager.ClickRemoteLocation(Enemies[0].Location.RayCast(Enemies[0].Rotation,10));
                                      });
            }
        }
