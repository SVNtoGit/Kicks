...
namespace Honorbuddy.Quest_Behaviors.CombatUseItemOnV2
{
    ...
    public class CombatUseItemOnV2 : QuestBehaviorBase
    {
        ...
        public override string SubversionId { get { return ("$Id: CombatUseItemOnV2.cs 566 2013-06-21 20:35:50Z chinajade $"); } }
        public override string SubversionRevision { get { return ("$Revision: 566 $"); } }
