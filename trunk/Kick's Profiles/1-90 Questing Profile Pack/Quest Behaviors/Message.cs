...
namespace Honorbuddy.Quest_Behaviors.Message
{
    ...
    public class Message : CustomForcedBehavior
    {
        ...
        public override string SubversionId { get { return ("$Id: Message.cs 415 2013-04-05 20:47:39Z chinajade $"); } }
        public override string SubversionRevision { get { return ("$Revision: 415 $"); } }
